...
echo "     (1 macOS arm64 + 1 Linux x86_64 wheel per Python version, plus 1 sdist):"
echo "     https://github.com/$REPO/releases/tag/$TAG"
echo ""
echo "  2. Optional but recommended: test-install from the release assets:"
echo "     ./test_pypi.sh $TAG"
echo ""
echo "  3. Open a pull request from prerelease to master:"
echo "     gh pr create --base master --title \"Release $TAG\""
echo ""
echo "  4. After the PR merges, publish the draft release:"
echo "     Go to https://github.com/$REPO/releases/tag/$TAG"
echo "     Scroll to the bottom of the draft release and click 'Publish release'."
echo "     This automatically uploads all wheels and the sdist to PyPI."
echo ""
