...
# the Linux and macOS arm64 wheels correctly.
#
...
# then cleans everything up after you
...
echo "  2. Pause for you to verify the draft release on GitHub"
echo "  3. Delete the test tag and draft release"
echo ""
...
# ---------------------------------------------------------------------------
# Step 1/2 — Create and push test tag
# ---------------------------------------------------------------------------

echo "--- 1/2  Creating and pushing test tag $TEST_TAG ---"
git tag "$TEST_TAG"
git push origin "$TEST_TAG"
echo ""
echo "     GitHub Actions is now creating the draft release and building"
echo "     the Linux and macOS arm64 wheels. Watch progress at:"
...
echo "--- 2/2  Verify the draft release ---"
echo ""
echo "Once the GitHub Actions wheel builds finish, confirm that all wheels"
