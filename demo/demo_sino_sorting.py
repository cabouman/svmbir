...
title = f'Slice {display_slice:d} of diff image between reconstruction with original sinogram and reconstruction with shuffled sinogram.'
...
title = f'Slice {display_slice:d} of diff image between reconstruction with shuffled sinogram and reconstruction with sorted sinogram.'
