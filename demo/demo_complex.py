...
print('Running qggmrf Reconstruction ----------------------------')
...
print('Running Proximal-map Reconstruction ----------------------------')
...
plt.colorbar()
plt.savefig('output/recon.png')
plt.close()

imgplot = plt.imshow(np.swapaxes(sino, 0, 1)[0])
imgplot.set_cmap('gray')
plt.colorbar()
plt.savefig('output/sino.png')
plt.close()

imgplot = plt.imshow(np.swapaxes(sino-proj, 0, 1)[0])
imgplot.set_cmap('gray')
plt.colorbar()
plt.savefig('output/err_sino.png')
plt.close()

imgplot = plt.imshow(x_rot[0])
imgplot.set_cmap('gray')
plt.colorbar()
plt.savefig('output/recon_rot.png')
plt.close()

imgplot = plt.imshow(x_combined[0])
imgplot.set_cmap('gray')
plt.colorbar()
plt.savefig('output/recon_combined.png')
plt.close()
